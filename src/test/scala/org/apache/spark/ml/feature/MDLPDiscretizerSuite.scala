...
class MDLPDiscretizerSuite extends FunSuite with BeforeAndAfterAll {
  ...
  test("Run MDLPD on all columns in titanic data (label = embarked)") {
    ...
    assertResult(
      """-Infinity, Infinity;
        |-Infinity, 6.6229, 7.18335, 7.2396, 7.6875, 7.7625, 13.20835, 15.3729, 15.74585, 56.7125, Infinity;
  ...
  test("Run MDLPD on all columns in titanic2 data (label = embarked)") {
    ...
    assertResult(
      """-Infinity, Infinity;
        |-Infinity, 7.175, 7.2396, 7.6875, 7.7625, 13.20835, 15.3729, 15.79585, 74.375, Infinity;
        |-Infinity, 1.5, 2.5, Infinity;
        |-Infinity, Infinity;
        |-Infinity, Infinity
        |""".stripMargin.replaceAll(System.lineSeparator(), "")) {
  ...
  test("Run MDLPD on all columns in titanic data (label = embarked, stoppingCriterion = -1e-2)") {
    ...
    assertResult(
      """-Infinity, Infinity;
        |-Infinity, 6.6229, 7.18335, 7.2396, 7.6875, 7.7625, 13.20835, 15.3729, 15.74585, 29.4125, 56.7125, Infinity;
        |-Infinity, 1.5, 2.5, Infinity;
        |-Infinity, 2.5, Infinity;
        |-Infinity, Infinity;
        |-Infinity, Infinity
  ...
  test("Run MDLPD on all columns in titanic data (label = sibsp)") {
    ...
    assertResult(
      """-Infinity, 14.75, Infinity;
        |-Infinity, 13.825, 28.2, 41.9896, 44.65, 47.0, 51.67085, 152.50626, Infinity;
        |-Infinity, 2.5, Infinity;
        |-Infinity, Infinity;
        |-Infinity, 1.44359817E12, Infinity
        |""".stripMargin.replaceAll(System.lineSeparator(), "")) {
  ...
  test("Run MDLPD on all columns in iris data (label = iristype, splittingCriterion = -0.01)") {
    ...
    assertResult(
      """-Infinity, 5.55, 6.15, Infinity;
        ...
        |-Infinity, 2.45, 4.75, 5.15, Infinity;
        |-Infinity, 0.8, 1.75, Infinity
        |""".stripMargin.replaceAll(System.lineSeparator(), "")) {
      model.splits.map(a => a.mkString(", ")).mkString(";")
    }
